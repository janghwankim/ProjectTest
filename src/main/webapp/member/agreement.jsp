...
제 1 조 (약관의 적용)
위드룸(이하"Wedroom corp."이라 합니다)의 이용에는 기본 이용약관(이하"기본약관"이라 합니다)과 이 약관을 함께 적용합니다
...
<div class="mb-4"></div>
	<button class="btn btn-outline-info btn-default" onclick="document.location='Register.jsp'">동의합니다</button>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<button class="btn btn-outline-info btn-default" onclick="history.back()">동의하지않습니다.</button>
</center>
</body>
</html>